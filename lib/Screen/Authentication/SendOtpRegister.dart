...
import 'VerifyOtpRegisster.dart';

class SendOtpRegister extends StatefulWidget {
  String? title;

  SendOtpRegister({Key? key, this.title}) : super(key: key);

  @override
  _SendOtpState createState() => _SendOtpState();
}

class _SendOtpState extends State<SendOtpRegister> with TickerProviderStateMixin {
  bool visible = false;
...
print("we are here==>");
            ...
            Future.delayed(const Duration(seconds: 1)).then(
                ...
                Navigator.pushReplacement(
                  context,
                  CupertinoPageRoute(
                    builder: (context) => VerifyOtpRegister(
                      mobileNumber: mobile!,
