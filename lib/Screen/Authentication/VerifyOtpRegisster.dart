...
class VerifyOtpRegister extends StatefulWidget {
...
class _MobileOTPState extends State<VerifyOtpRegister> with TickerProviderStateMixin {
      ...
      _firebaseAuth.signInWithCredential(authCredential).then(
          ...
          if (value.user != null) {
            ...
            if (widget.title == getTranslated(context, "SEND_OTP_TITLE")) {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => SellerRegister(mobileno: '+${widget.countryCode}-${widget.mobileNumber}')));
