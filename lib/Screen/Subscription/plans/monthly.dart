      ...
      Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                int value =
                    int.parse(widget.subscriptionList[index]["price"]);
                return Padding(
                    ...
                    child: InkWell(
                        onTap: () {
                          setState(() {
                            ...
                            MainPrice =
                            widget.subscriptionList[index]['monthy_discounted_price'];
                          });
                          print(
    ...
    isSelected == true ? GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => SelectedSubscription(
